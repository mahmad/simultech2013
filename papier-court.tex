...
\author{\authorname{Manzoor Ahmad, Iulia Dragomir, Jean-Michel Bruel, and Iulian Ober}
\affiliation{IRIT, Universit\'e de Toulouse, France}
\email{\{ahmad,dragomir,bruel,iulian.ober\}@irit.fr}
}
